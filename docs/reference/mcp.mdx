...
Any string you send is limited to 16 KB, and it may not contain control characters other than tab and newline. Lambo names the offending codepoint rather than echoing the raw byte.
...
| A string over the size cap or carrying a control character | The field, the cap, and the size given, or the offending codepoint. |
