...
| HTTP | `lambo serve --session demo --transport http` | Streamable HTTP on port `7700`, bound to `127.0.0.1`. |

<Warning>
The HTTP endpoint has no authentication yet. Keep it on localhost.
</Warning>
