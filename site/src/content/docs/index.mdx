...
<CardGrid cols={2}>
  <LinkCard title="Quickstart" href="/lambo/quickstart/" description="Build Lambo from source and run your first session in about 30 seconds." />
  <LinkCard title="Demo" href="/lambo/demo/" description="Watch two agents build one REST API and share load-bearing memory." />
  <LinkCard title="Installation" href="/lambo/installation/" description="Build from source, choose features, and connect an MCP client." />
