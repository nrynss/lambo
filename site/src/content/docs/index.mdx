---
# The tab title. `hero.title` below is what the page displays, so this only
# has to stop the browser tab reading "Lambo | Lambo".
...
hero:
  ...
  # Only the two the sidebar cannot offer. Quickstart and Evidence are one
  # click away in the sidebar and again in the cards below, so buttons for
  # them would be a third copy of the same link.
  actions:
    - text: "Try it live"
