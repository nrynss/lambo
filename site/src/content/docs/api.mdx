...
These are library settings, not `lambo.toml` keys. The file only chooses the store and the embedder, and it refuses any other key. See [Configuration](/lambo/config/).
