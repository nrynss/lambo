...
- Send the id on one line. `agent_id` refuses newlines and tabs even though other strings accept them, because your id is rendered into other agents' context blocks as the holder of your locks, and a line break there would let you write lines into someone else's context.
