...
Create a `lambo.toml` that selects the in-memory store and the fixture embedder. This file is how you choose backends. The binary already carries all of them.
