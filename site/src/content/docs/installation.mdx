...
For a durable store, run `scripts/provision.sh` to create the schema before you serve. See [Configuration](/lambo/config/) for the store keys and the provisioning details.
