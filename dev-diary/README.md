...
| P7 | 3 / 4 | T7.0 done; T7.1 blocked on account; T7.2 hybrid done, T7.3 Cockroach vector_candidates DONE on phase (merged 2026-08-13) — camera-proof EXPLAIN vector-search PENDING on the multi-region cluster (open item, see T7.3 handoff) |
