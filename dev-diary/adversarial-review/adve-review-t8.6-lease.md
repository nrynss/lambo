...
```text
╔══════════════════════════════════════════════════════════════════╗
║  STATUS: R1 OPEN — findings for remediation                      ║
...
║  P1: none                                                        ║
║  P2: 3 (loser-refusal degrades to opaque BUSY; lost-lease keeps  ║
║        writing; cockroach acquire not wrapped in tx_retry)       ║
║  P3: 3 (unbounded non-serve close vs TTL; leaked-handle wedge;   ║
║        cross-process winner-liveness untested)                   ║
║  Opened: 2026-08-14                                              ║
╚══════════════════════════════════════════════════════════════════╝
```
