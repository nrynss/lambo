...
| File | Scope | Status |
|------|-------|--------|
| [adve-review-c5-models-round1.md](adve-review-c5-models-round1.md) | codex/c5-models — C5 model re-run (Qwen3-0.6B swarm + functiongemma-270m no-tool-call finding), round 1 | **REQUEST_CHANGES** (2 P2 / 2 P3; probes/ledger/durability/portal all verified against artifacts — P2s are OMP-infeasibility under-evidence + fallback-loop agency framing, 2026-08-18) |
