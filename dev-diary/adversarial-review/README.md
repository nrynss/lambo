...
| File | Role | Status |
|------|------|--------|
| **[adve-review-t14-fixtures.md](adve-review-t14-fixtures.md)** | **Main — T1.4 fixture graphs** | **OPEN** (REJECT — must-fix) |
| **[adve-review-t70-embeddings.md](adve-review-t70-embeddings.md)** | **Main — T7.0 embeddings (BGE-M3 / llama.cpp)** | **CLOSED** (ACCEPT) |
